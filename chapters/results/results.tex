...
Using this method, we recovered that \gls{hbv}-A had an inferred effective population size of \barneycomment{XXX [95\% HPD:X--Y]} and that \gls{hbv}-D had an inferred effective population size of 60,686 [95\% HPD: 38,478--86,598].
...
\begin{figure}[ht]
  \centering
  \medskip
  \includegraphics[width=.9\textwidth]{HBV-A_new_sequences}
...
\begin{figure}[ht]
  \centering
  \medskip
  \includegraphics[width=.9\textwidth]{HBV-D_new_sequences}
...
\begin{figure}[ht]
  \centering
  \medskip
  \includegraphics[width=.9\textwidth]{HBV-E_new_sequences}
...
We confirmed the estimated number of geographic transitions by counting Markov jumps on each posterior tree \barneycomment{(Fig.~MarkovJumps)}.
...
\begin{figure}[ht]
  \centering
  \medskip
  \includegraphics[width=.9\textwidth]{HBV-A_phylogeography_and_mcc_tree}
...
\begin{figure}[ht]
  \centering
  \medskip
  \includegraphics[width=.9\textwidth]{HBV-D_phylogeography_and_mcc_tree}
...
\begin{figure}[ht]
  \centering
  \medskip
  \includegraphics[width=.9\textwidth]{bayes_factors}
...
\begin{figure}[ht]
  \centering
  \medskip
  \includegraphics[width=.9\textwidth]{l-skygrid-population-reconstruction}
...
\begin{figure}[ht]
  \centering
  \medskip
  \includegraphics[width=.9\textwidth]{2020-03-05_L_prelim}
