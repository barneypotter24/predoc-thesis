...
In doing so, I seek to determine a ``subgenotype'' label for each new sequence. %GB: can you provide some more information on how this will actually be done (from the e-mails/papers from Bobby)?
