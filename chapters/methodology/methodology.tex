...
We analyzed a total of 1,590 complete hepatitis B virus (HBV) genomes divided among three genotypes, and arising from three primary sources: publicly available sequence databases, novel genomes sequenced by collaborators, and recently sequenced ``ancient'' genomes isolated from mummies.
