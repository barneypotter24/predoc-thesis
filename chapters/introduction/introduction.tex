...
Visual examples of all of these aspects of phylodynamic analyses are illustrated in Figure~\ref{fig:phylogeneticsOverview}\cite{pybus2009evolutionary}.
...
\begin{figure}[ht]
  ...
  (\textit{Photo credit: Pybus \& Rambaut. Nature. 2009.}\cite{pybus2009evolutionary})
  }
